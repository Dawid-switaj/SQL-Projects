...
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'CoffeBase')
BEGIN
    CREATE DATABASE CoffeBase;
END
GO
...
-- Insert remaining values into the employees table (daty poprawione na format YYYY-MM-DD)
