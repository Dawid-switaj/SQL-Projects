/*
/== Database Setup ==========================================\
|  Creates or recreates 'DataWarehouseAnalytics' database     |
|  Initializes schema: gold                                   |
\=============================================================/ 

⚠️  Warning:
    This script drops the existing database. All data will be
    permanently lost. Ensure backups are available.
*/
